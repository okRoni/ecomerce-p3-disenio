...
VALUES
('Cedula Nacional', '101010101', 'Carlos', 'Martínez', 'Jimenez', 'Costarricense', '1985-06-15', 'carlos.martinez@example.com', '8888-5555', 'San Jose', 'Central', 'Carmen'),
('Pasaporte', 'P123456', 'Ana', 'Gonz�lez', 'Rodríguez', 'Nicaragüense', '1990-08-22', 'ana.gonzalez@example.com', '8877-6666', 'Alajuela', 'Central', 'San José'),
('Cedula Nacional', '202020202', 'Luis', 'Ramírez', 'Soto', 'Costarricense', '1975-12-03', 'luis.ramirez@example.com', '8866-7777', 'Heredia', 'Central', 'Heredia');

-- Insertar veh�culos en la tabla Vehiculo
...
VALUES
('SUV', 'Toyota', 'RAV4', 2020, 'ABC123', 15000000, 1, 1, '4x4', 5, 4.60, 1.85, 1.70, 'Cuero', 'Gasolina', 1, 1, 1, 1, 1, 0, 0, '100% tactil', 'Autom�tica', 'Tela', 'Estéreo 7.1', '3', 0),
